...
public class Mbest700 implements ClientModInitializer {
    ...
    // --- TÜM DEĞİŞKENLER (Eksiksiz Tanımlandı) ---
    ...
    public static void init() {
        // Eksilen hiçbir ayar yok, hepsi burada!
    ...
    // --- AUTO SWORD HIT: SADECE BAKINCA VE GERİ DÖNEREK ---
    ...
    private static void doLockedAnchor() {
        ...
        // Paket Hatası Fix: float, float, boolean, boolean
    ...
    public static class AmethystGui extends Screen {
        ...
        public void render(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            context.drawText(this.textRenderer, "§dMbest700 §fV16", 20, 20, 0xFFFFFF, true);
            int x = 20; int y = 40;
